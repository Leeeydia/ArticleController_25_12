...
private static void makeLoginData() {
    System.out.println("== 로그인 테스트 데이터 생성 ==");
    members.add(new Member(11, "2025-12-09 12:12:12", "2025-12-09 12:12:13", "abc123", "abc123", "abc"));
    members.add(new Member(12, Util.getNowStr(), Util.getNowStr(), "def123", "abc123", "def"));
    members.add(new Member(13, Util.getNowStr(), Util.getNowStr(), "ghi123", "abc123", "ghi"));
}
}
